      ...
      <div className="px-4 sm:px-6 lg:px-0 max-w-2xl mx-auto w-full mb-6 sm:mb-8">
        <div className="flex items-center gap-4 sm:gap-6 mb-6">
          <div className="relative group shrink-0">
            ...
            <div 
              className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden bg-[#080810] border-4 border-[#080810] ring-1 ring-white/10 shrink-0 cursor-pointer hover:opacity-90 transition-opacity active:scale-95 shadow-2xl"
              onClick={() => setIsImageModalOpen(true)}
            >
              {profile.image ? (
                <img src={profile.image} alt="" className="w-full h-full object-cover" />
              ) : (
                <div className="w-full h-full flex items-center justify-center text-2xl sm:text-3xl md:text-4xl">👤</div>
              )}
            </div>
          </div>
          
          <div className="flex flex-col min-w-0 flex-1">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-white tracking-tight truncate leading-tight">
              {profile.firstName} {profile.lastName}
            </h1>
            <p className="text-indigo-400 font-medium tracking-wide text-[10px] sm:text-xs md:text-sm">@{profile.userName}</p>
            <p className="text-white/30 text-[9px] sm:text-[10px] md:text-xs mt-0.5 truncate">{profile.email}</p>
          </div>
        </div>
      ...
      <div className="w-full flex justify-center mb-8 sm:mb-10 px-4 sm:px-6 lg:px-0">
        <div className="flex gap-6 sm:gap-10 py-3 sm:py-4 px-6 sm:px-10 bg-white/[0.02] rounded-2xl sm:rounded-3xl border border-white/5 backdrop-blur-md">
          <div className="flex flex-col items-center">
            ...
            <span className="text-white/20 text-[9px] sm:text-[10px] uppercase tracking-widest font-black">Posts</span>
          </div>
          <div 
          ...
          >
            ...
            <span className="text-white/20 text-[9px] sm:text-[10px] uppercase tracking-widest font-black">Followers</span>
          </div>
          <div 
            className="flex flex-col items-center cursor-pointer hover:opacity-70 transition-opacity"
          ...
          >
            ...
            <span className="text-white/20 text-[9px] sm:text-[10px] uppercase tracking-widest font-black">Following</span>
          </div>
        </div>
      </div>
