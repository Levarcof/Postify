...
export default function MainLayout() {
  ...
  return (
    <div className={`bg-[#080810] text-white flex ${isConversation ? 'h-[100dvh] overflow-hidden w-full !fixed inset-0' : 'min-h-screen'}`}>
      {/* GLOWS */}
      ...
      {/* MIDDLE SECTION - FEED */}
      <main className={`flex-1 flex flex-col items-center pt-6 pb-24 lg:ml-64 px-4 md:px-8 z-10 ${isConversation ? '!mx-0 !w-full !max-w-none !px-0 !pt-0 !pb-0 !ml-0 h-full overflow-hidden' : 'xl:mr-80'}`}>
