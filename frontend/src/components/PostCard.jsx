        ...
        <div className="px-6 pb-6 bg-white/[0.01] border-t border-white/[0.03] animate-in slide-in-from-top duration-300">
          ...
          <div className="flex gap-3 pt-4 border-t border-white/[0.06]">
            <input 
              ...
              className="flex-1 bg-white/[0.05] border border-white/10 rounded-xl px-4 py-2 text-base text-white placeholder-white/20 outline-none focus:border-indigo-500/50"
